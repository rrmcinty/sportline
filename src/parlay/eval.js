 ...
 */
export function evaluateParlay(spec) {
    ...
    // Calculate payout
    const payout = calculateParlayPayout(legs.map((leg) => leg.decimalOdds), stake);
 ...
 */
export function rankParlaysByEV(parlays) {
 ...
 */
export function filterPositiveEV(parlays) {
 ...
 */
export function generateParlays(legs, minLegs = 2, maxLegs = 4, stake = 10) {
    const parlays = [];
