 ...
 */
export async function backtestUnderdogModel(sport, seasons, tiers, minEdge = 0.03) {
 ...
 */
export async function compareUnderdogVsMainModel(sport, seasons) {
...
//# sourceMappingURL=underdog-backtest.js.map